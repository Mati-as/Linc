...
public class Network_BeadsGenerator : MonoBehaviour
{
    ...
    private void Init()
    {
        ...
        _spawnPosA = transform.GetChild(0).transform.Find("Network_GeneratePositionRight").position;
        _spawnPosB = transform.GetChild(0).transform.Find("Network_GeneratePositionLeft").position;
