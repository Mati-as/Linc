...
public class RaySynchronizer : MonoBehaviour
{
    ...
    private Base_NetworkGameManager _baseNetworkGameManager;
    ...
    public virtual void Init()
    {
        ...
        GameObject.FindWithTag(GAME_MANAGER).TryGetComponent(out _baseNetworkGameManager);

        Debug.Assert(_baseNetworkGameManager != null);
