...
//        Debug.Log("Get RectRansfrom Pool.");
    ...
    private void Start()
    {
      ...
      //  _heightSlider.value = Managers.Setting.SCREEN_PROJECTOER_HEIGHT_FROM_XML;
     //   _TMP_height.text = "HEIGHT : " + Managers.Setting.SCREEN_PROJECTOER_HEIGHT_FROM_XML.ToString("F1");
